...
Pour travailler en dehors de QGIS, j’ai mis en place un environnement virtuel spécifique à ce projet.
Il est défini dans le fichier `requirements.yml`, que je garde dans le dossier envs/.
